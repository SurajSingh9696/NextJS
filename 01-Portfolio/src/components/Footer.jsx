            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10 text-center md:text-left">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    >
                        ...
                        <span className="font-semibold text-lg">singhbb954@gmail.com</span>
                    </a>
                </div>
                ...
                <div className="flex flex-col gap-6 items-center md:items-end">
                    <div className="flex gap-5">
                        <a href="https://github.com/SurajSingh9696" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors">
                            <Github size={24} />
                        </a>
                        <a href="https://www.linkedin.com/in/suraj-singh-070a73213/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors">
                            <Linkedin size={24} />
                        </a>
                    </div>

                    <div className="text-xs text-gray-500 font-medium bg-gray-900/50 px-4 py-2 rounded-full border border-gray-800">
                        © {new Date().getFullYear()} · Designed & Built by <span className="text-purple-400">Suraj Singh</span>
                    </div>
                </div>
